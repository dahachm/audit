...
Для автоматического учета неуспешных попыток авторизации пользователей был разработан [bash-скрипт](task_5.sh), собирающий информацию о событиях из журналов
...
1) Попытка выполнить команду, требующую повышенных привилегий, пользователем без sudo прав
   ...
   позже [**вот в этом**](https://github.com/dahachm/audit/blob/main/MyScripts/README.md#%D1%84%D0%B8%D0%BB%D1%8C%D1%82%D1%80-%D1%81%D0%BE%D0%B1%D1%8B%D1%82%D0%B8%D0%B9-%D0%BF%D0%BE-%D0%B2%D1%80%D0%B5%D0%BC%D0%B5%D0%BD%D0%B8) разделе.
...
4) Ввод неверного пароля при попытке входа в систему (fly-dm)
